...
- Используй нижние подчёркивания вместо пробелов. Пример: "United States" → "United_States".
- Тире заменяй на подчёркивания. Пример: "Well-being" → "Well_being".
- Аббревиатуры без точек. Пример: "U.S.A." → "USA".
